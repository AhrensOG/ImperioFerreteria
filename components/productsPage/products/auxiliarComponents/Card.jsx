...
const Card = ({
  ...
  return (
    <div className="grid grid-cols-1 justify-items-stretch content-between max-w-[285px] sm:w-[285px] sm:h-[500px] divide-y divide-slate-400 border border-[#e26928] hover:-translate-y-2 duration-500 hover:shadow-lg hover:shadow-black/60">
      <img src={url} alt="img" className="w-[300px] h-[250px]" />
      <div className="flex flex-col w-full sm:h-[250px] sm:max-h-[250px] items-center justify-end px-4 py-6 gap-4">
